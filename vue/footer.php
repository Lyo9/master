...
<div class="flex-container flex-footer" >
    ...
    <div class="footer_section">
          <div class="footer-section-infos footer_last_section">
            <span>© Lyon9Corp</span>
        </div>
        <div class="footer-section-reseau footer_last_section">
            <span>LOIC<br>
            GASTAR<br>
            Email / tel: contact@lyon9.fr / 04 84 25 01 28<br></span>
        </div>
        <div class="footer-section-reseau footer_last_section">
            <i class="icon fa fa-facebook-official fa-4x facebook" aria-hidden="true"></i>
            <i class="icon fa fa-twitter fa-4x twitter" aria-hidden="true"></i>
            <i class="icon fa fa-instagram fa-4x instagram" aria-hidden="true"></i>
        </div>  
    </div>
